                                    ...
                                    <div class="dropdown-large__menu">
                                        <ul class="dropdown-large__list">
                                            <li class="dropdown-large__list-item">
                                                <a class="dropdown-large__list-link" href="">Financial Services</a>
                                            </li>
                                            <li class="dropdown-large__list-item">
               ...
               <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                            <img class="navbar-photo" src="{{ asset('images/users/user-male.jpeg') }}" alt="username">
                            AG
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-user fade-down">
                            <li class="dropdown-menu-user__header">
                                <div class="card-user-menu">
                                    <div class="card-user-menu__image-container">
                                        <img class="card-user-menu__image" src="{{ asset('images/users/user-male.jpeg') }}" alt="username">
                                    </div>
